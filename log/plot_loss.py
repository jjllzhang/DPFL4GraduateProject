...
directory = './MNIST/max_norm=0.1_sigma=1.1'  # CSV文件目录
...
for filename in os.listdir(directory):
    if filename.endswith('.csv'):
        ...
        # 绘制图形
        plt.plot(data['epoch'], data['test_loss'], label=simplified_filename)
...
# 保存为PNG文件，设置dpi为300
plt.savefig('./MNIST/max_norm=0.1_sigma=1.1/test_loss_MNIST.png', dpi=300, bbox_inches='tight')
